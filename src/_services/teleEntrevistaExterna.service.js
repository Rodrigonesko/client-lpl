...
export const filterPropostas = async ({ status, tipoContrato, vigencia, altoRisco }) => {
    return await new ApiCall('/filterPropostas', URL_API).post({ status, tipoContrato, vigencia, altoRisco })
}