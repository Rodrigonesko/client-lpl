...
export const filterPropostas = async ({ status, tipoContrato, vigencia, altoRisco, page, limit }) => {
    return await new ApiCall('/filterPropostas', URL_API).post({ status, tipoContrato, vigencia, altoRisco, page, limit })
}