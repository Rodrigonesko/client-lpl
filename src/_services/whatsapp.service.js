...
const URL_API_BRADESCO = process.env.REACT_APP_WHATS_SINDICANCIA_BRADESCO
...
export const updateNumeroBradesco = async (data) => {
    return await new ApiCall(`/conversa/update/${data.id}`, URL_API_BRADESCO).put(data)
}