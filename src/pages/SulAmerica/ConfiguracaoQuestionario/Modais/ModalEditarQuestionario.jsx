...
import { buscarPerguntas, updateQuestionario } from "../../../../_services/sulAmerica.service";
...
const ModalEditarQuestionario = ({ questionario, setFlushHook }) => {
    ...
    const handleAlterar = async () => {
        ...
        try {
            ...
            await updateQuestionario(questionario._id, auxQuestionario)
                ...
                >
                    {
                        refQuestionario.perguntas.sort((a, b) => {
                            ...
                            >
                                <Typography>
                                    {pergunta.posicao}. {pergunta.pergunta.pergunta}
                                </Typography>
                                <IconButton
                                    onClick={() => {
