        ...
        try {
            ...
            response.forEach(pedido => {
                worksheet.addRow({
                    ...
                    uf: pedido?.nf?.uf,
                    conselhoProfissional: pedido.conselhoProfissional,
                    classificacaoCRM: pedido.classificacaoCRM,
                    tipo: pedido.tipo,
                    ...
                    dataInicioApolice: pedido?.apolice?.data,
                    ...
                    comprovantePagamento: pedido.comprovantePagamento,
