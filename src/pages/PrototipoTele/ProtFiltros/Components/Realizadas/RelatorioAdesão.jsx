    ...
    const handleGenerate = async () => {
        try {
            ...
            const columns = [
                ...
                { header: 'Vigencia Amil', key: 'vigenciaAmil', width: 10 },
                ...
                { header: 'Motivo cancelamento', key: 'motivoCancelamento', width: 10 },
            ...
            result.entrevistas.forEach(e => {
                ...
                worksheet.addRow({
                    ...
                    vigenciaAmil: new Date(e?.idProposta?.vigenciaAmil),
                    ...
                    motivoCancelamento: e.cancelado ? e.divergencia : '',
